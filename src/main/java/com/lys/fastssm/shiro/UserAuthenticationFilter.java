...
import com.lys.fastssm.base.BaseAuthenticationService;
...
public class UserAuthenticationFilter extends FormAuthenticationFilter {
	...
	protected boolean executeLogin(ServletRequest request, ServletResponse response) throws Exception {
		try {
            ...
            boolean rememberMe = !StringUtils.isEmpty(rememberMeValue) && ("1".equals(rememberMeValue) || "true".equalsIgnoreCase(rememberMeValue));
