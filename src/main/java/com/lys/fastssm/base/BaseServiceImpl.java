...
import com.lys.fastssm.mybatis.PageResult;
...
public abstract class BaseServiceImpl<T> implements BaseService<T> {
	 ...
	 * @return 返回 mapper
	 */
	public abstract com.lys.fastssm.base.BaseMapper<T> getMapper();
	...
	protected void criteriaOperator(Example example, Criteria criteriaNew, PageCondition condition) {
		...
		if(condition.getColumnName() != null && condition.getColumnName().length() > 0) {
			//获取操作类型
			String operator = (condition.getOperator() != null && condition.getOperator().length() > 0) ? condition.getOperator() : Constant.OPERATOR_EQUAL;
			if(Constant.OPERATOR_EQUAL.equalsIgnoreCase(operator)){
				criteriaNew.andEqualTo(condition.getColumnName(), condition.getValue());
			}else if(Constant.OPERATOR_NOT_EQUAL.equalsIgnoreCase(operator) || Constant.OPERATOR_GREATER_LESS.equalsIgnoreCase(operator)){
				criteriaNew.andNotEqualTo(condition.getColumnName(), condition.getValue());
			}else if(Constant.OPERATOR_LIKE.equalsIgnoreCase(operator)){
				criteriaNew.andLike(condition.getColumnName(), condition.getValue().toString());
			}else if(Constant.OPERATOR_NOT_LIKE.equalsIgnoreCase(operator)){
				criteriaNew.andNotLike(condition.getColumnName(), condition.getValue().toString());
			}else if(Constant.OPERATOR_GREATER.equalsIgnoreCase(operator)){
				criteriaNew.andGreaterThan(condition.getColumnName(), condition.getValue());
			}else if(Constant.OPERATOR_GREATER_EQUAL.equalsIgnoreCase(operator)){
				criteriaNew.andGreaterThanOrEqualTo(condition.getColumnName(), condition.getValue());
			}else if(Constant.OPERATOR_LESS.equalsIgnoreCase(operator)){
				criteriaNew.andLessThan(condition.getColumnName(), condition.getValue());
			}else if(Constant.OPERATOR_LESS_EQUAL.equalsIgnoreCase(operator)){
				criteriaNew.andLessThanOrEqualTo(condition.getColumnName(), condition.getValue());
			}else if(Constant.OPERATOR_IN.equalsIgnoreCase(operator)){
				criteriaNew.andIn(condition.getColumnName(), (List<?>)condition.getValue());
			}else if(Constant.OPERATOR_NOT_IN.equalsIgnoreCase(operator)){
				criteriaNew.andNotIn(condition.getColumnName(), (List<?>)condition.getValue());
			}else if(Constant.OPERATOR_IS_NULL.equalsIgnoreCase(operator) || Constant.OPERATOR_IS_EMPTY_NULL.equalsIgnoreCase(operator)){
				criteriaNew.andIsNull(condition.getColumnName());
			}else if(Constant.OPERATOR_IS_NOT_NULL.equalsIgnoreCase(operator)){
