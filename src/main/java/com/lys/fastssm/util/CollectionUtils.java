...
import com.lys.fastssm.callback.AbstractTreeRecursionCallback;
...
public class CollectionUtils<IN, OUT> {
	 ...
	 * @return
	 */
	public static <IN, OUT> List<OUT> treeRecursion(List<IN> inputList, OUT outputParent, AbstractTreeRecursionCallback<IN, OUT> treeRecursionCallback){
